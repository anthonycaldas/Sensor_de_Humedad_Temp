/*
Proyecto: Sensor de Humedad y Temperatura 
Asignatura: Internet de las Cosas 
NRC: xxxx

Descripción breve:
Sistema que tiene como funcion medir la humaded y temperatura del suelo y 
del hambiente dando como resultado los mensajes de "☀️ AMBIENTE SECO " u "💧 HUMEDAD DETECTADA" acorde a 
como este la tierra.
...
Referencias:
- Enlaces, tutoriales o documentación consultada

Autores:
- Caldas Godoy Anthony Freddy
- Angulo Orellana Jose Ibrahin
- Cruz Angulo Nayeli Noemi
*/
